...
from treesearch.types import StateScoreType
from treesearch.types import StateScoreCostType
...
class Node(Generic[StateT]):
    ...
    # this list is needed to see the whole decoding
...
class Tree(Generic[StateT]):
    ...
    def add_node(
        self, state_score_cost: StateScoreCostType[StateT], parent: Node[StateT]
    ) -> Node[StateT]:
        state, score, scores, cost, total_cost, output_cost, total_output_cost, input_cost, total_input_cost, prm_output_cost, prm_total_output_cost, prm_input_cost, prm_total_input_cost = state_score_cost
        node = Node(
            state=state,
            score=score, 
            scores=scores,
            cost=cost, total_cost=total_cost, 
            output_cost=output_cost, total_output_cost=total_output_cost,
            input_cost=input_cost, total_input_cost=total_input_cost,
            prm_output_cost=prm_output_cost, prm_total_output_cost=prm_total_output_cost,
            prm_input_cost=prm_input_cost, prm_total_input_cost=prm_total_input_cost,
            parent=parent, 
