...
from treesearch.algos.ab_mcts_a.prob_state import NodeProbState, PriorConfig
...
class ABMCTSA(Algorithm[StateT, ABMCTSAAlgoState[StateT]]):
    ...
    Original paper: https://openreview.net/forum?id=jAsr5GHt3P
